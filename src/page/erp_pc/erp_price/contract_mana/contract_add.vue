                ...
                >
                    ...
                    <template slot="custom-add-form">
                        <el-form ref="addOrEditForm" :rules="mainRules" :model="addOrEditForm" :inline="otherVariable.isInlineForm" label-width="120px">
                            ...
                            <el-form-item label="合同日期" prop="docDate">
                                <el-input></el-input>
                                <!--<el-date-picker
                            ...
                            <el-form-item label="生效日期" prop="docDate">
                                <el-input></el-input>
                                <!--<el-date-picker
                                    :readonly="operateType === 'edit'"
                                    v-model="addOrEditForm.docDate"
                            ...
                            <el-form-item label="失效日期" prop="docDate">
                                <el-input></el-input>
                                <!--<el-date-picker
                                    :readonly="operateType === 'edit'"
                                    v-model="addOrEditForm.docDate"
                            ...
                            <div class="inline-form-title">财务信息</div>
