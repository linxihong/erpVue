...
<script>
    ...
    export default {
        ...
        data() {
            return {
                ...
                ajaxConfig: {
                    ...
                    addObj: {
                        url: '/oms/pqm/PqmRouteGroupController/addPriceList',
                        method: 'fetch'
                    },
                    updateObj: {
                        url: '/oms/pqm/PqmRouteGroupController/updatePriceList',
                        method: 'fetch'
                    },
                    deleteObj: {
                        url: '/oms/pqm/PqmRouteGroupController/detelePriceList',
                        method: 'fetch'
                    }
                },
                searchProp: [
        ...
        methods: {
            ...
            getColorGroup() {
                this.fetch('/oms/pqm/PqmRouteGroupController/selectRouteGroupList',{})
                    .then(result => {
            ...
            //获取单位
            getUom() {
                this.getAjax('/basedata/sys/DataDictionary/getDataDictionary?docCode=30134')
                    .then(result => {
                        if(result.data) {
