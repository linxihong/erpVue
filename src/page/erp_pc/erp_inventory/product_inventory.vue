<template>
    <div class="common-wrap flex-column">
        ...
        <el-form :model="searchForm" :inline="true" @submit.native.prevent @keyup.enter.native="getData" label-width="100">
        ...
        <div>
            ...
            <el-checkbox style="margin-left: 10px;"  @change="changeSelf" v-model="searchForm.isOpen"  true-label="1" false-label="0">展开汇总</el-checkbox>
        </div>
        </div>
        ...
        >
            ...
            <el-table-column prop="storageCode" label="仓库"  :show-overflow-tooltip="true" align="right"></el-table-column>
            <el-table-column prop="stockDigit" label="支数"  :show-overflow-tooltip="true" align="right" width="130"></el-table-column>
            <el-table-column prop="stockTheroyWght" label="重量"  :show-overflow-tooltip="true" align="right" width="130"></el-table-column>
                ...
                <template slot-scope="scope">
                    <el-dropdown @command="handleCommand($event,scope.row,scope.$index)" trigger="click">
                        ...
                        <el-dropdown-menu slot="dropdown" class="del-shadow">
                            <el-dropdown-item command="a" >料框库存</el-dropdown-item>
    ...
    export default {
        ...
        data() {
            return {
                ...
                //表格映射列表
                tableProp: [
                    {prop:'clientCode2', name:'经销商代码',type:'normal',align:'left',},
                    ...
                    {prop:'storageCode', name:'仓库',type:'normal',align:'left',width:'130'},
                    {prop:'digit', name:'支数',type:'normal',align:'right',width:'130'},

                    {prop:'clientCode2',name:'重量',type:'normal',align:'left',width:'130'},
        ...
        watch:{
            '$store.state.order_Code':function (val) {
        ...
        mounted() {
            ...
            this.$set(this.searchForm,'clientCode2',this.$store.state.order_Code);
            this.getData();
            this.getTotal();
        ...
        methods: {
            getData() {
                this.fetch(`/oms/pcs/StockSearch/getClientWarehouse?pageNo=${this.pageObj.commonPage}&pageSize=${this.pageObj.commonSize}`,this.searchForm)
                    .then(result => {
                        if(result.data) {
            ...
            getTotal(){
                this.fetch(`/oms/pcs/StockSearch/getClientWarehouseTotal`,this.searchForm)
                    .then(result => {
                        if(result.data) {
            ...
            handleCommand(command,row,index){
                if(command === 'a'){
                    ...
                    this.$store.state.storageCode = row.storageCode;
